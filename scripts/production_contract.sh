...
grep -q 'ensureSoundGroup("Music"' "$ROOT_DIR/src/server/ServerMain.server.lua" || fail "Music SoundGroup is missing"
grep -q 'ensureSoundGroup("Ambience"' "$ROOT_DIR/src/server/ServerMain.server.lua" || fail "Ambience SoundGroup is missing"
